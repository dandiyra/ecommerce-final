            ...
            <div class="col-lg-5 order-3">
                <div class="product_description">
                    ...
                    <div class="product_price">
                        Rp{{ $product->discount_price }}<span>Rp{{ $product->selling_price }}</span></div>
                    @endif
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-60d043b5a44f919f"></script>
