        ...
        <div class="row">
            ...
            <div class="col-5 offset-lg-1">
                ...
                <ul class="list-group col-lg-12">
                    ...
                    <li class="list-group-item"> <b>Subtotal:</b> Rp {{ $track->subtotal  }}</li>
                    <li class="list-group-item"> <b>Shipping:</b> Rp {{ $track->shipping  }}</li>
                    <li class="list-group-item"> <b>Vat:</b> Rp {{ $track->vat  }}</li>
                    <li class="list-group-item"> <b>Total:</b> Rp {{ $track->total  }}</li>
