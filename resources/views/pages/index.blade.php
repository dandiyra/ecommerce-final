                                    ...
                                    <div
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="product_price discount">
                                                Rp{{ $row->discount_price }}<span>Rp{{ $row->selling_price }}</span>
                                            </div>
                                            @endif
...
$product =
DB::table('products')->where('category_id',$catid)->where('status',1)->limit(10)->orderBy('id','DESC')->get();
                            ...
                            <div class="trends_item is_new">
                                ...
                                <div class="trends_content">
                                    ...
                                    <div class="trends_info clearfix">
                                        <div class="trends_name"><a href="product.html">{{ $row->product_name }}</a>
                                        </div>
                                        @if($row->discount_price == NULL)
