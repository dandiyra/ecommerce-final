            ...
            <div class="row row-sm">
                <div class="col-sm-6 col-xl-3">
                    <div class="card pd-20 bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h3 class="mg-b-0 tx-white tx-lato tx-bold">Rp {{ $today }}</h3>
                        </div><!-- card-body -->
                    </div><!-- card -->
                </div><!-- col-3 -->
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
                    <div class="card pd-20 bg-info">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="sparkline2"></span>
                            <h3 class="mg-b-0 tx-white tx-lato tx-bold">Rp {{ $month }}</h3>
                        </div><!-- card-body -->
                    </div><!-- card -->
                </div><!-- col-3 -->
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
                    <div class="card pd-20 bg-purple">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="sparkline2"></span>
                            <h3 class="mg-b-0 tx-white tx-lato tx-bold">Rp {{ $year }}</h3>
                        </div><!-- card-body -->
                    </div><!-- card -->
                </div><!-- col-3 -->
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
                    <div class="card pd-20 bg-orange">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="sparkline2"></span>
                            <h3 class="mg-b-0 tx-white tx-lato tx-bold">Rp {{ $delevery }} </h3>
                        </div><!-- card-body -->
                    </div><!-- card -->
                </div><!-- col-3 -->
            </div><!-- row -->
            ...
            <div class="row row-sm">
                <div class="col-sm-6 col-xl-3">
                    <div class="card pd-20 bg-danger">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="sparkline2"></span>
                            <h3 class="mg-b-0 tx-white tx-lato tx-bold">Rp{{ $return }}</h3>
                        </div><!-- card-body -->
                    </div><!-- card -->
                </div><!-- col-3 -->
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
